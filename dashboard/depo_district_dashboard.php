...
<?php
include('get_depos_district.php');
?>
...
<body>
  ...
  <div class="col-sm-12 p-3">
    ...
    <div class="row">
         ...
         <h1 class=" text-center h1 alert alert-primary">Depots Data District Wise</h1>
         </div>
      <div class="col-lg-12 mx-auto">
 ...
 <div class="top-holder mr-md-2 mb-md-0 mb-4 mx-auto mx-md-0  d-lg-flex">
        ...
        ?>
        <a href="depo_listing_dashboard.php?dd=<?php echo $sums['id'] ?>" target="_blank">
          <div class="filter-result">
