...
<?php
include('get_depos_district_id.php');
...
<body>
  <div class="container-fluid p-5">
    ...
    <div class="row">
        ...
        <h1 class="mb-4 text-center">Depos Stock ( ton)</h1>
...
$serial = 1; // Initialize a counter variable
         while ($row_d = $depo_data->fetch_assoc())  { ?>
                <tr>
            ...
            echo $total;
        ?><span class="text_quan"> ton</span></b></td>
         ...
         <td> <?php echo $row_d["dispatch"]; ?><span class="text_quan"> ton</span></td>
            ...
            $closing = $total - $dispatch - $today_sale;
            echo $closing;
        ?><span class="text_quan"> ton</span></b></td>
        
          
                   <td> <?php echo $row_d["date"]; ?></td>
                </tr>
            <?php  
               $serial++;
            } 
